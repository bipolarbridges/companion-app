...
import { MasloPage, Container, Card } from 'src/components';
...
const display = [{title : 'In the Polarus App. access Settings on the top right of your Profile.',image: Images.notificationScreen1},
{title : 'Next, tap on Notification Preferences to turn on/off notifications.', image: Images.notificationScreen2},
{title : 'Tap on Customize Notifications to set domain preferences.', image: Images.notificationScreen3},
]
