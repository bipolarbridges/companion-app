...
export class ChooseStrategiesView extends ViewState {
    ...
    onSubmit = () => {
        AppController.Instance.User.backend.setUserStateProperty(
            'chosenStrategies',
            this.viewModel.selectedStrategies.map((s) => s.id),
        );
    ...
    renderContent() {
        return (
            <MasloPage
                ...
                onBack={() => this.onBack()}>
                <Container
                    style={[{ height: this._contentHeight, paddingTop: 10 }]}>
                    {/* Title */}
                    <View
                        style={{
                        ...
                        <Text style={[TextStyles.h2, styles.strategy]}>
                            {'Choose up to 4 focus strategies below.'}
                        </Text>
                    </View>
                    ...
                    />
                    <Button
                        title="SELECT THESE STRATEGIES"
                        style={styles.selectButton}
                        onPress={this.onSubmit}
                        disabled={this.viewModel.selectedStrategies.length < 1}
                    />
                </Container>
            </MasloPage>
        );
