...
export class StrategyDetailsView extends ViewState {
    ...
    renderIconItem = ({ item }) => (
        <View
            ...
            <Text style={[TextStyles.h2, styles.strategy, { display: 'flex' }]}>
                ...
                <Container
                    ...
                    <View
                        ...
                        <Text style={[TextStyles.h2, styles.strategy]}>
                            {this._learnMoreStrategy.title}
                        </Text>
                    </View>
                    {/* Subtitle */}
                    <Text style={[TextStyles.p2, styles.strategy]}>
                        {
                            'This strategy targets personal improvement in these life domains:'
                        }
                    </Text>
                    {/* Icon Container */}
                    <FlatList
                        style={styles.list}
                        data={
                            this.viewModel.learnMoreStrategy
