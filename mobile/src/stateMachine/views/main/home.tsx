...
@observer
export class HomeView extends ViewState<{
    opacity: Animated.Value;
    isUnfinishedQol: boolean;
}> {
    ...
    async start() {
        ...
        this.setState({
            ...this.state,
            isUnfinishedQol: AppViewModel.Instance.QOL.isUnfinished,
        });
                ...
                <Animated.View
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <Button
                            ...
                            onPress={() => this.onStartDomains()}
                        />
                    </View>
                    {this.state.isUnfinishedQol === null ? (
                        <Text>Loading..</Text>
                    ) : (
                        this.getTitle()
                    )}
