...
export class ChooseDomainView extends ViewState {
    constructor(props) {
        super(props);
        this._contentHeight = this.persona.setupContainerHeightForceScrollDown({
            rotation: -15,
    ...
    onSelectDomain = (n: string) => {
        ...
        if (hasThreeSelected) {
            ...
            (hasTwoSelected || hasThreeSelected) &&
    ...
    renderContent() {
        ...
        const [
            ...
            rDomain,
            importance,
        ] = this.viewModel.getDomainDisplay();
            ...
            <MasloPage
                ...
                <Container
                    ...
                    <View
                        ...
                        <Text style={[TextStyles.p1, styles.domain]}>
                            {domain}
                        </Text>
                    ...
                    <View
                        ...
                        <View
                            ...
                            <TouchableOpacity
                                ...
                                <Text
                                    style={{
                                        fontWeight:
                                            active === 0 ? 'bold' : 'normal',
                                        textDecorationLine:
                                            active === 0 ? 'underline' : 'none',
                                    }}>
                                    Importance
                                </Text>
                            </TouchableOpacity>
                        ...
                        <ScrollView>
                            ...
                            <Animated.View
                                ...
                                <Text
                                    ...
                                    {
                                        'Complete at-least one week of check-ins to use your timeline.'
                                    }
                                </Text>
                            </Animated.View>
                        </ScrollView>
                        <View
                            ...
                            <Button
                                title={
                                    active === 0 ? 'View Details' : 'Calendar'
                                }
                                style={styles.buttonDetails}
                                titleStyles={styles.mailButtonTitle}
                                onPress={
                                    active === 0 ? () => this.onDetails() : null
                                }
                                isTransparent
                            />
                        </View>
